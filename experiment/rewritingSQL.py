...
def execute(sql: str):
    ...
    with open("./customer/cost.txt", "a", encoding='utf-8') as f:
        f.write(line1 + '\n')
    cur.close()
...
if __name__ == '__main__':
    ...
    table_list = [Table(1, "cus1", [12, 6, 14, 13, 20, 17, 16, 3, 2, 18, 15, 5, 8], [8], []),
                  Table(2, "cus2", [8, 9, 10, 1, 4, 11, 0], [8], []),
                  Table(3, "cus3", [1, 4, 11, 0, 10, 9, 7], [1, 4, 11, 0], [])]
