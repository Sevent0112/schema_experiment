...
if __name__ == '__main__':
    ...
    table_list = [Table(1, "tab1", [19, 68, 49], [19, 68, 49], []),
                  Table(2, "tab2", [19, 13, 68], [19, 68], []),
                  Table(3, "tab3", [68, 49, 41, 7], [68, 49], []),
                  Table(4, "tab4", [68, 41, 77], [68, 41], []),
                  Table(5, "tab5", [19, 91], [19], []),
                  Table(6, "tab6", [41, 81, 93, 87, 29, 78, 44, 43, 53, 0, 88, 58, 86, 64, 18, 73, 31, 57, 80, 67], [41], []),
                  Table(7, "tab7", [87, 5, 67], [87, 67], []),
                  Table(8, "tab8", [5, 1, 67], [5, 67], []),
                  Table(9, "tab9", [90, 10, 72, 52, 35, 36, 3, 94, 82, 83, 24, 46, 74, 51, 20, 26, 68], [68], []),
                  Table(10, "tab10", [75, 82, 20], [82, 20], []),
                  Table(11, "tab11", [94, 26, 69], [94, 26], []),
                  Table(12, "tab12", [94, 92, 20], [94, 20], []),
                  Table(13, "tab13", [10, 9], [10], []),
                  Table(14, "tab14", [75, 55, 8], [75], []),
                  Table(15, "tab15", [55, 47], [55], []),
                  Table(16, "tab16", [8, 66], [8], []),
                  Table(17, "tab17", [61, 37, 11, 33, 48, 17, 59, 63, 85, 50, 84, 45, 42, 60, 25, 23, 71, 76, 38, 21, 32, 6, 65, 14, 12, 34, 89, 62, 30, 15, 16, 22, 56, 39, 4, 54, 40, 2, 27, 66], [66], [])]
